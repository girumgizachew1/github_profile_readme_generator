  ...
  return (
    <div className="w-full h-full">
      <div className="flex space-x-2 mb-4 justify-between text-sm">
        ...
        <button
          className="px-6 py-2 flex justify-right bg-gray-800 text-zinc-100 rounded-lg flex space-x-2"
          onClick={() => {
        ...
        <button className="px-6 py-2 flex justify-right bg-gray-800 text-zinc-100 rounded-lg flex space-x-2" onClick={() => { setMarkdownView(!MarkdownView) }} >
